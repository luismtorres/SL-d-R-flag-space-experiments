...
Moreover, the limit sets of Borel Anosov subgroups of SL(d,R) can be understood as also living in this more restricted space, and understanding the connected components by permutations and applying iota to the middle flag informs whether or not certain constructions of these subgroups is possible.
